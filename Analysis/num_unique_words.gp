...
set ylabel "Number of unique words"
...
set output "num_unique_words.svg"

plot input using 1:6 with lines lc rgb cardinal,\
     ""    using 1:6:2 with labels hypertext point pt 7 lc rgb cardinal
